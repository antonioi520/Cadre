 ...
 */
function textareasCreate(request) {
    var promise = new Promise(function(resolve, reject) {
        ...
        } else if(!request.body.textareaLabel) {
            // Required fields
                ...
                .exec(function(error, viewsiteData) {
                    if(viewsiteData.userId != request.session.userId) {
                        ...
                        viewsiteData
                            ...
                            'textareaLabel': request.body.textareaLabel
                        });
 ...
 */
function textareasUpdate(request) {
    var promise = new Promise(function(resolve, reject) {
        if(!request.body.viewsiteId
            || !request.body.viewpageId
            || !request.body.elementId
 ...
 */
function textareasDelete(request) {
    var promise = new Promise(function(resolve, reject) {
        if(!request.body.viewsiteId
            || !request.body.viewpageId
            || !request.body.elementId
...
module.exports.textareasCreate = textareasCreate;
module.exports.textareasUpdate = textareasUpdate;
module.exports.textareasDelete = textareasDelete;
