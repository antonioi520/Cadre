 ...
 */
function numbersCreate(request) {
    var promise = new Promise(function(resolve, reject) {
        ...
        } else if(!request.body.numberLabel) {
            // Required fields
                ...
                .exec(function(error, viewsiteData) {
                    if(viewsiteData.userId != request.session.userId) {
                        ...
                        viewsiteData
                            ...
                            'numberLabel': request.body.numberLabel
                        });
 ...
 */
function numbersUpdate(request) {
    var promise = new Promise(function(resolve, reject) {
        if(!request.body.viewsiteId
            || !request.body.viewpageId
            || !request.body.elementId
 ...
 */
function numbersDelete(request) {
    var promise = new Promise(function(resolve, reject) {
        if(!request.body.viewsiteId
            || !request.body.viewpageId
            || !request.body.elementId
...
module.exports.numbersCreate = numbersCreate;
module.exports.numbersUpdate = numbersUpdate;
module.exports.numbersDelete = numbersDelete;
